    ...
    <form onSubmit={handleSubmit} className='w-full max-w-sm mx-auto'>
      <div className='mt-10 flex'>
        <input
          ...
          className='form-input block w-full py-2 px3 border border-grey-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150'
          required
        />
        <button
          type='submit'
